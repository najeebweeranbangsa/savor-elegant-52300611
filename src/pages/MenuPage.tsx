  ...
  useEffect(() => {
    const fetch = async () => {
      const [c, i] = await Promise.all([
        supabase.from("menu_categories").select("*").eq("archived" as any, false).order("sort_order"),
        supabase.from("menu_items").select("*").eq("archived" as any, false).order("sort_order"),
      ]);
